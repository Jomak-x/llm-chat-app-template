/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3d7e3fa2275efede95b6730dd6f4a551)
// Runtime types generated with workerd@1.20251217.0 2025-10-08 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "LearningCoachSessionDurableObject";
	}
	interface Env {
		CORS_ORIGIN: "*";
		LEARNING_SESSIONS: DurableObjectNamespace<import("./src/index").LearningCoachSessionDurableObject>;
		AI: Ai;
		MATERIAL_INGESTION_WORKFLOW: Workflow<Parameters<import("./src/index").MaterialIngestionWorkflow['run']>[0]['payload']>;
	}
}
